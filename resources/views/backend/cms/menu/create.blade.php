        ...
        <form action="{{route('backend.cms.menus.store')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="card flex-row-fluid mb-2 mt-5  ">
                <div class="card-body">
                        ...
                        <div class="col form-group ">
                            ...
                            <select class="form-control type" id="type"
                                ...
                                @foreach($types as $type)
                                    <option value="{{$type}}"
                                        {{old('type') == $type? "selected":"" }}>{{trans('backend.menu.'.$type)}}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="row  mb-4 @if(old('type') != 'header') d-none @endif" id="icon-wrapper">
                        <div class="col">
                            <div class="form-group">

            {!! single_image('icon' , media_file(old('icon')), get_setting('icon' ), 'image',['watermark'=>'no' ,'width'=>70 , 'height'=>70] ) !!}
