    ...
    <div class="col">
        <div class="card   flex-row-fluid mb-2  ">
            <div class="card-header">
                <h3 class="card-title"> {{trans('backend.menu.manufacturers')}}</h3>
                ...
                <div class="table-responsive">
                    <table id="datatable" class="table table-rounded table-striped border gy-7 w-100 gs-7">
                        ...
                        <tr class="fw-bold fs-6 text-gray-800 border-bottom border-gray-200">
                            ...
                            <th>{{trans('backend.manufacturer.title')}}</th>
                            <th>{{trans('backend.manufacturer.image')}}</th>
                            <th>{{trans('backend.manufacturer.type')}}</th>
