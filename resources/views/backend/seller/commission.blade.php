...
@section('title',trans('backend.seller.commission', ['name' => $seller->name]).' | '.get_translatable_setting('system_name', app()->getLocale()))
    ...
    <div class="col">
        <div class="card   flex-row-fluid mb-2  ">
            <div class="card-header">
                <h3 class="card-title"><b class="las la-percent"></b> {{trans('backend.seller.commission', ['name' => $seller->name])}}</h3>
                <div class="card-toolbar">
                    <button type="button" data-seller="{{$seller->id}}" class="btn btn-primary" id="add-seller"><i
                            class="fa fa-plus"></i> {{trans('backend.global.create_new_item')}}</button>
                </div>
            </div>
            <!--begin::Card Body-->
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <div class="btn btn-icon btn-sm btn-active-light-primary ms-2" data-bs-dismiss="modal"
                         aria-label="Close">
                        <span class="svg-icon svg-icon-2x"><i class="las la-times"></i></span>
                    </div>
                    <!--end::Close-->
                </div>
                ...
                <div class="modal-body">
                    <form id="add_commission">
                        ...
                        <div class="mb-10">
                            ...
                            <input type="number" step="0.0001" class="form-control form-control-solid"
