        ...
        <div class="card   flex-row-fluid mb-2  ">
            ...
            <div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
                <div class="row">
                    ...
                    {!! multi_select_2('type', $filters_type, trans('backend.notifications.notification_type')) !!}
    ...
    <script>
        ...
        $(document).on('click', '.read', function () {
            ...
            $.ajax({
                ...
                url: '{{route('backend.notifications.read')}}',
                method: "post",
                data: {
                    '_token': '{{csrf_token()}}',
                    'id': id,
        ...
        $(document).on('click', '.read-all', function () {
            ...
            $.ajax({
                ...
                url: '{{route('backend.notifications.read_all')}}',
                method: "post",
                data: {
                    '_token': '{{csrf_token()}}',
                }, success: (response) => {
