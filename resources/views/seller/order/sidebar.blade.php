@if(permission_can('show orders' ,'seller'))
    <div class="menu-item @if(request()->routeIs('seller.orders.*')) here show @endif">
    <a class="menu-link" href="{{ route("seller.orders.index") }}">
