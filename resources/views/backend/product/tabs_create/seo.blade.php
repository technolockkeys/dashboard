                    ...
                    <div class="row">
                        <div class="col-12 col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control has-error" name="title_meta_{{$item->code}}" value=" {{old('title_meta_'.$item->code)}}"
                        ...
                        <div class="col-12 col-md-12 form-group ">
                            <div class="form-group">
                                ...
                                > {{old('description_meta_'.$item->code)}}</textarea>
...
{{--            <br>--}}
{{--            {!! single_image('meta_image' ,media_file( old('meta_image')), old('meta_image')) !!}--}}
{{--        </div>--}}
{{--    </div>--}}
{{--</div>--}}
