    ...
    <div class="card card-flush py-4 mt-3">
        <div class="card-header">
            <div class="card-title">
                <h2><label for="image">{{trans('backend.product.videos')}}</label>
        ...
        <div class="card-body">
            <div class="col-12 col-md-12 mt-3">
                ...
                @endphp
                <div id="add_videos" @if(empty(old('video_url',$video_url)) ) class="d-none" @endif>

                    @if(!empty(old('video_url[]',$video_url)) )
                        @foreach(old('video_url[]',$video_url) as $key=>$item)
