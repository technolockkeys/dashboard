@if(permission_can('show wallet', 'seller') && false )
<div class="menu-item @if(request()->routeIs('seller.wallet.*')) here show @endif">
    <a class="menu-link" href="{{ route("seller.wallet.index") }}">
...
<path d="M18 5H17C16.4 5 16 4.6 16 4V2H19V4C19 4.6 18.6 5 18 5Z" fill="currentColor"/>
        ...
        <span class="menu-title">
                    {{ trans('backend.seller.wallet') }}</span>
    </a>
</div>
@endif
