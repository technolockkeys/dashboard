...
class TicketUserMail extends Mailable implements ShouldQueue
{
    ...
    public function build()
    {
        ...
        return $this->subject($this->subject)->view('backend.mails.ticket_user_notification', ['details' => $this->details]);
    }
}
