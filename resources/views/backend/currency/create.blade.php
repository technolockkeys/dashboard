...
@section('content')
    <div class="col">
        <form action="{{route('backend.currencies.store')}}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="card flex-row-fluid mb-2  ">
                <div class="card-header">
                    <h3 class="card-title"> {{trans('backend.currency.create_new_currency')}}</h3>
                ...
                <div class="card-body">
                    ...
                    <div class="col">
                        <div class="  mb-10">
                            ...
                            <input required autocomplete="off" type="text" class="form-control" id="code" name="code" value="{{old('code')}}"
                    ...
                    <div class="col">
                        <div class="  mb-10">
                            ...
                            <input required autocomplete="off" type="number" min="0" step="0.000001" class="form-control" id="value" name="value" value="{{old('value')}}"
                                   placeholder="{{trans('backend.currency.value')}}"/>
                            @error('value') <b class="text-danger"><i class="las la-exclamation-triangle"></i> {{$message}} </b> @enderror
                    ...
                    <div class="col">
                        <div class="  mb-10">
                            ...
                            <input required autocomplete="off" type="text"  class="form-control" id="symbol" name="symbol" value="{{old('symbol')}}"
                                   placeholder="{{trans('backend.currency.symbol')}}"/>
                            @error('symbol') <b class="text-danger"><i class="las la-exclamation-triangle"></i> {{$message}} </b> @enderror
