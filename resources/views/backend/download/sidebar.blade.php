@if(permission_can('show downloads' ,'admin') )
    <div
            class="menu-item  @if(request()->routeIs('backend.downloads.*')  ) show @endif ">
...
<path opacity="0.3" d="M8 17.4H16L12.7 20.7C12.3 21.1 11.7 21.1 11.3 20.7L8 17.4Z" fill="currentColor"/>
                                            ...
                                            <a class="menu-title"
                                               href="{{route('backend.downloads.index')}}">
                                                <span class="menu-title">{{trans('backend.menu.downloads')}}</span>
                                            </a>
