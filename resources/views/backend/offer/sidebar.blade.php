@if(permission_can('show offers' ,'admin') )
    <div
            class="menu-item  @if(request()->routeIs('backend.offers.*')  )here show @endif ">
        <a class="menu-link"
           href="{{route('backend.offers.index')}}">

										<span class="menu-icon">
<!--begin::Svg Icon | path: /var/www/preview.keenthemes.com/kt-products/docs/metronic/html/releases/2022-10-09-043348/core/html/src/media/icons/duotune/ecommerce/ecm007.svg-->
...
<path opacity="0.3" d="M9 2C10.7 2 12 3.3 12 5V8H9C7.3 8 6 6.7 6 5C6 3.3 7.3 2 9 2ZM4 12V21C4 21.6 4.4 22 5 22H10V12H4ZM20 12V21C20 21.6 19.6 22 19 22H14V12H20Z" fill="currentColor"/>
            ...
            <span class="menu-title">{{trans('backend.menu.offers')}}</span>
