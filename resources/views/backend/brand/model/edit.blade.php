...
@section('content')
    <div class="col">
        {{ Form::model($model, array('method' => 'PATCH', 'route' => array('backend.brands.models.update', $model->id))) }}
        @csrf
        <div class="card flex-row-fluid mb-2  ">
            <div class="card-header">
                <h3 class="card-title"> {{trans('backend.brand.edit_model', ['name'=> $model->model])}}</h3>
                <div class="card-toolbar">
                    <a href="{{route('backend.brands.models.index',['brand_id'=> $model->brand_id])}}" class="btn btn-info"><i
                            ...
                            <div class="row mb-6">
                                <div class="col-12 col-md-12 mb-10">
                                    ...
                                    <input class="form-control" id="model_{{$item->code}}"
                                           ...
                                           value="{{old('model_'.$item->code, $model->getTranslation('model', $item->code))}}"
                        ...
                        <div class="form-group  align-items-center">
                            ...
                            <div class="form-check form-switch form-check-custom form-check-solid me-10">
                                <input class="form-check-input h-20px w-30px"
                                       @if(old('status', $model->status) == 1) checked @endif type="checkbox" value="1"
