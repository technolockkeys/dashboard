<table class="table    border gy-7 w-100 gs-7   " id="datatable">
    <thead>
    <tr>
        <th class="  small">{{trans('backend.wallet.order')}}</th>
        <th class="  small">{{trans('backend.wallet.user')}}</th>
        <th class="  small">{{trans('backend.order.seller')}}</th>
        <th class="  small">{{trans('backend.wallet.amount')}}</th>
        <th class="  small">{{trans('backend.global.status')}}</th>
        <th class="  small">{{trans('backend.global.created_at')}}</th>
        <th class="  small">{{trans('backend.global.actions')}}</th>
    </tr>
    </thead>
