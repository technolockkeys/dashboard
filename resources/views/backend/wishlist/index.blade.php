...
@section('title',trans('backend.menu.wishlists').' | '.get_translatable_setting('system_name', app()->getLocale()))
    ...
    <div class="col">
        <div class="card   flex-row-fluid mb-2  ">
            <div class="card-header">
                <h3 class="card-title"> {{trans('backend.menu.wishlists')}}</h3>

            </div>
            <!--begin::Card Body-->
            <div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
                <div class="row">
                    {!! multi_select_2('product', $products,'backend.user.product') !!}
                    {!! multi_select_2('user', $users,'backend.user.name') !!}
                </div>
                {!! apply_filter_button() !!}
