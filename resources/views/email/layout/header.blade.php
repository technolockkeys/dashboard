...
<div class="es-wrapper-color" style="background-color:#EEEEEE"><!--[if gte mso 9]>
    ...
    <table class="es-wrapper" width="100%" cellspacing="0" cellpadding="0"
                    ...
                    <tr style="border-collapse:collapse">
                        <td align="center" style="padding:0;Margin:0">
                            <table class="es-header-body"
                                   style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:#fff;width:600px"
                                   cellspacing="0" cellpadding="0" bgcolor="#fff" align="center">
                                <tr style="border-collapse:collapse">
                                    <td align="center"
                                        style="Margin:0;width: 100%;padding-top:35px;padding-bottom:35px;padding-left:35px;padding-right:35px">
                                        <!--[if mso]>
                                        <table style=";width: 100%" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td style=";width: 100%" valign="top"><![endif]-->
                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0"
                                                        ...
                                                        <tr style="border-collapse:collapse">
                                                            <td class="es-m-txt-c" align="center"
                                                                ...
                                                                <img width="100px"
                                                                     src="{{media_file(get_setting("default_images"))}}"
                                                                     alt=""></td>
                                                        </tr>
                                                    </table>
                                                </td>
        ...
        @include('email.layout.header_image')
