                                                        ...
                                                        <table width="100%" border="0" cellpadding="0" cellspacing="0"
                                                            ...
                                                            <tr>
                                                                <td width="100%" align="center"
                                                                    ...
                                                                    Congregates: New coupon for you
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                        ...
                                                        <table width="100%" border="0" cellpadding="0" cellspacing="0"
                                                            ...
                                                            <tr>
                                                                <td width="100%" align="center"
                                                                    ...
                                                                    A {{$details['coupon']->discount}} {{$details['coupon']->type == \App\Models\Coupon::$Amount? '$': '%'}} DISCOUNT FOR YOU
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                            ...
                                                            <table align="center" width="500" border="0" cellspacing="0"
                                                                ...
                                                                <tr>
                                                                    <td valign="middle" align="left" width="63%"
                                                                        ...
                                                                        <a href="https://dttlk.esg-s.com/product/{{$product->slug}}" style="text-decoration: none">
                                                                    ...
                                                                    <td width="25%" align="left"
                                                                        ...
                                                                        @endphp
                                                                        <span style="font-size:15px; color:#aaaaaa; font-family:'Lato',Arial, sans-serif; font-weight:700;"> {{currency($product_price)}}</span>
                                                                    </td>
                                            ...
                                            <table align="center" width="100%" border="0" cellspacing="0"
                                                ...
                                                <tr>
                                                    <td valign="top" align="center"
                                                        ...
                                                        Copyright © 2022 Technolock. All Rights Reserved
                                                    </td>
                                                </tr>
                                            </table>
