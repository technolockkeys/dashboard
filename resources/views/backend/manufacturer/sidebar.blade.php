@if(permission_can('show manufacturers' ,'admin') )
    <div
            class="menu-item  @if(request()->routeIs('backend.manufacturers.*')  )here show @endif ">
        <a class="menu-link"
           href="{{route('backend.manufacturers.index')}}">

										<span class="menu-icon">
<!--begin::Svg Icon | path: /var/www/preview.keenthemes.com/kt-products/docs/metronic/html/releases/2022-08-17-055145/core/html/src/media/icons/duotune/ecommerce/ecm008.svg-->
...
<path d="M15 18.6C15 20.3 16.3 21.6 18 21.6C19.7 21.6 21 20.3 21 18.6V12.5C21 12.2 20.6 12 20.3 12.2L19 13.6L17.7 12.3C17.3 11.9 16.7 11.9 16.3 12.3L15 13.6V18.6Z" fill="currentColor"/>
            ...
            <span class="menu-title">{{trans('backend.menu.manufacturers')}}</span>
