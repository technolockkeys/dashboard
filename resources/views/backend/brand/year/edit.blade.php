...
@section('content')
    <div class="col">
        {{ Form::model($year, array('method' => 'PATCH', 'route' => array('backend.brands.models.years.update', $year->id))) }}
            @csrf
            <div class="card flex-row-fluid mb-2  ">
                <div class="card-header">
                    <h3 class="card-title"> {{trans('backend.brand.edit_year', ['name' => $year->year])}}</h3>
                        ...
                        <div class="col  align-items-center">
                            <div class="form-group  align-items-center">
                                ...
                                <div class="form-check form-switch form-check-custom form-check-solid me-10">
                                    <input class="form-check-input h-20px w-30px" @if(old('status', $year->status) == 1) checked @endif type="checkbox" value="1"
