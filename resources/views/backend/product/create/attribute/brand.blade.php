                        ...
                        @foreach(old('brand',[]) as $key =>$old_item)
                            ...
                            <div class="row" id='row_brand_{{$key}}'>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select data-control="select2" class="form-control brands" name="brand[]"
                                            ...
                                            @foreach($brands as $brand)
                                                <option @if($brand->id == $old_item ) selected
                                ...
                                <div class='col-1 col-md-1'>
                                    <button type='button' onclick="add_new_brand()"
                        ...
                        <div class="form-group">
                            ...
                            <select data-control="select2" class="form-control brands" name="manufacturer"
                                ...
                                @foreach($manufacturers as $manufacturer)
                                    <option @if($manufacturer->id == old('manufacturer') ) selected
                                            @endif  value="{{$manufacturer->id}}">{{$manufacturer->title}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    <div class="col-12 col-md-4 d-none" id="manufacturer_type_wrapper">
                        <div class="form-group">
                            ...
                            <select data-control="select2" class="form-control brands" name="manufacturer_type"
                                ...
                                <option value="">{{trans('backend.product.please_select_option')}}</option>
                                <option @if('software' == old('manufacturer_type') ) selected
                                        @endif  value="token">{{trans('backend.manufacturer.software')}}</option>
                                <option @if('token' == old('manufacturer_type') ) selected
