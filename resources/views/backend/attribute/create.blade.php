...
@section('content')
    <div class="col">
        <form action="{{route('backend.attributes.store')}}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="card flex-row-fluid mb-2  ">
                <div class="card-header">
                    <h3 class="card-title"> {{trans('backend.attribute.create_new_attribute')}}</h3>
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="name_{{$language->code}}" @if($key == 0 ) required @endif
                                                   name="name_{{$language->code}}" value="{{old('name_'.$language->code)}}">
