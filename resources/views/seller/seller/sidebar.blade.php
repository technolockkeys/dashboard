...
@if(auth('seller')->user()->is_manager == 1 && permission_can('show sellers', 'seller'))
    <div
            class="menu-item  @if(request()->routeIs('seller.sellers.*')  ) here show @endif ">
        <a class="menu-link"
           href="{{route('seller.sellers.index')}}">
