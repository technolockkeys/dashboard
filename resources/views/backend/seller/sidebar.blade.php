@if(permission_can('show sellers' ,'admin'))
    <div data-kt-menu-trigger="click"
         class="menu-item menu-accordion @if(request()->routeIs('backend.sellers.*')) show @endif ">
...
<path d="M6 10C6 11.1 5.1 12 4 12C2.9 12 2 11.1 2 10H6ZM10 10C10 11.1 10.9 12 12 12C13.1 12 14 11.1 14 10H10ZM18 10C18 11.1 18.9 12 20 12C21.1 12 22 11.1 22 10H18ZM19 2H5C4.4 2 4 2.4 4 3V4H20V3C20 2.4 19.6 2 19 2ZM12 17C12 16.4 11.6 16 11 16H6C5.4 16 5 16.4 5 17C5 17.6 5.4 18 6 18H11C11.6 18 12 17.6 12 17Z" fill="currentColor"/>
										...
										<span class="menu-title">{{trans('backend.menu.sellers')}}</span>
										<span class="menu-arrow"></span>
									</span>
        <div class="menu-sub menu-sub-accordion  ">
            @if(permission_can('show sellers' ,'admin'))
                <div class="menu-item @if(request()->routeIs('backend.sellers.*') && !request()->routeIs('backend.sellers.earning')  ) show @endif">
                    <a class="menu-link" href="{{route('backend.sellers.index')}}">
            ...
            @endif
            @if(permission_can('show sellers' ,'admin'))
                <div class="menu-item @if( request()->routeIs('backend.sellers.earning')  ) show @endif">
                    <a class="menu-link" href="{{route('backend.sellers.earning')}}">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
                        <span class="menu-title">{{trans('backend.menu.sellers_earning')}}</span>
                    </a>
                </div>
            @endif
        </div>
