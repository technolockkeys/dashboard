    ...
    <div class="col">
        <div class="card   flex-row-fluid mb-2  ">
            <div class="card-header">
                <h3 class="card-title"> {{trans('backend.menu.years')}}</h3>
                <div class="card-toolbar">
                    {!! @$create_button !!}
                    <a href="{{route('backend.brands.models.index',$model->brand->id)}}" class="btn btn-info"><i
                ...
                <div class="table-responsive">
                    <table id="datatable" class="table table-rounded table-striped border gy-7 w-100 gs-7">
                        ...
                        <tr class="fw-bold fs-6 text-gray-800 border-bottom border-gray-200">
                            ...
                            <th>{{trans('backend.brand.year')}}</th>
