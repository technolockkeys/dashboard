    ...
    <div class="col">
        <div class="card   flex-row-fluid mb-2  ">
            <div class="card-header">
                <h3 class="card-title"> {{trans('backend.menu.menus')}}</h3>
            ...
            <div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
                <div class="row">
                    ...
                    {!! multi_select_2('type', $types,'backend.menu.type') !!}
                    {!! select_status() !!}
                </div>
                {!! apply_filter_button() !!}
                ...
                <div class="table-responsive">
                    <table id="datatable" class="table table-rounded table-striped border gy-7 w-100 gs-7">
                        ...
                        <tr class="fw-bold fs-6 text-gray-800 border-bottom border-gray-200">
                            ...
                            <th>{{trans('backend.menu.type')}}</th>
                            <th>{{trans('backend.menu.title')}}</th>
                            <th>{{trans('backend.menu.link')}}</th>
