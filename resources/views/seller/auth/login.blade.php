    ...
    <div
        ...
        <div class="d-flex flex-center flex-column flex-column-fluid p-10 pb-lg-20">
            ...
            <div class="w-lg-500px bg-body rounded shadow-sm p-10 p-lg-15 mx-auto">
                <!--begin::Signin Form-->
                <form method="POST" action="{{ route('seller.login') }}" class="form w-100" novalidate="novalidate"
                      id="sign_in_form">
                @csrf
                <!--begin::Heading-->
                ...
                <!--begin::Input group-->
                    <div class="fv-row mb-10">
                        <!--begin::Label-->
                        <label class="form-label fs-6 fw-bolder text-dark">{{trans('seller.auth.email')}}</label>
                        <!--end::Label-->
                        ...
                        <input
                            ...
                            autofocus placeholder="{{ trans('seller.auth.email') }}">
                        @if($errors->has('email'))
                    ...
                    <div class="fv-row mb-10">
                        ...
                        <div class="d-flex flex-stack mb-2">
                            <!--begin::Label-->
                            <label
                                class="form-label fw-bolder text-dark fs-6 mb-0">{{trans('seller.auth.password')}}</label>
                            <!--end::Label-->
                        ...
                        <input
                            ...
                            placeholder="{{ trans('seller.auth.password') }}">
...
{{--    <script type="text/javascript" src="{{asset('ba/js/login/index.js')}}"></script>--}}
