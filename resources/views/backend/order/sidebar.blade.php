@if(permission_can('show orders' ,'admin') )
    <div
            class="menu-item  @if(request()->routeIs('backend.orders.*')  )here show @endif ">
        <a class="menu-link"
           href="{{route('backend.orders.index')}}">

										<span class="menu-icon">
<!--begin::Svg Icon | path: assets/media/icons/duotune/coding/cod002.svg-->
<span class="svg-icon svg-icon-muted svg-icon-hx"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
...
<path d="M9 19C9 20.7 7.7 22 6 22C4.3 22 3 20.7 3 19H9Z" fill="currentColor"/>
            ...
            <span class="menu-title">{{trans('backend.menu.orders')}}</span>
