                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="mb-0 me-1">
                                    <a @if($notification->notifiable_type == \App\Models\Product::class)
                                       ...
                                       href="{{auth('admin')->check() ? route('backend.orders.show', [ 'order' =>$notification->notifiable_id])  :route('seller.orders.show', [ 'order' =>\App\Models\Order::find($notification->notifiable_id)->uuid])  }}"
