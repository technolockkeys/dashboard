                                            ...
                                            <table width="100%" border="0" cellpadding="0" cellspacing="0"
                                                ...
                                                <tr>
                                                    <td valign="middle" width="100%" style="text-align: center;"
                                                        class="fullCenter" object="image-editable">
                                                        <a href="#" target="_blank" style="text-decoration:none;"><img
                                                                class="em_logo"
                                                                src="{{media_file(get_setting('system_logo_icon'))}}"
                                                                alt="logo" width="51" height="51" border="0"
                                                                style="
                                                                text-align:center;"/></a>
                                                    </td>
                                                </tr>
                                    ...
                                    <td align="center" width="100%" valign="middle" bgcolor="#ffffff"
                                        ...
                                        <div class="sortable_inner">
                                            <table width="100%" border="0" cellpadding="0" cellspacing="0"
                                                   ...
                                                   style="border-top-right-radius: 5px; border-top-left-radius: 5px;">
                                                <tr>
                                                    <td align="center" valign="bottom" bgcolor="#2c2a2b"
                                                        style="border-top-right-radius: 5px; border-top-left-radius: 5px;">
                                                        <img src="images/img2.png" alt="" class="em_full_img" border="0"
                                                ...
                                                <tr>
                                                    <td align="center" width="250" valign="middle" class="em_pad">
                                                        ...
                                                        <table width="100%" border="0" cellpadding="0" cellspacing="0"
                                                            ...
                                                            <tr>
                                                                <td width="100%" align="center"
                                                                    style="font-size:30px; color:#161619; font-family:'Lato',Arial, sans-serif; font-weight:400; line-height:34px;">
                                                                    {{$details['title']}} </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                                        ...
                                                                        <table border="0" cellpadding="0"
                                                                            ...
                                                                            <tr>
                                                                                <td align="center" valign="middle"
                                                                                    ...
                                                                                    <a href="{{get_setting('app_url')}}" target="_blank"
                                                                                       style="text-decoration:none; color:#ffffff; line-height:31px; display:block;"
                                                                                       object="link-editable"> visit website</a>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                    </div>
                                            ...
                                            <table align="center" width="100%" border="0" cellspacing="0"
                                                   cellpadding="0" object="drag-module-small">
                                                <tr>
                                                    <td height="25" class="em_h20"><img src="images/spacer.gif"
                                                                                        width="1" alt="" height="1"
                                                                                        border="0"
                                                                                        style="display:block;"/></td>
                                                </tr>
                                            ...
                                            <table align="center" width="100%" border="0" cellspacing="0"
                                                ...
                                                <tr>
                                                    <td valign="top" align="center"
                                                        ...
                                                        >{{get_translatable_setting('system_name','en')}}.</a> All
                                                        Rights Reserved.
                                                    </td>
                                                </tr>
                                            </table>
