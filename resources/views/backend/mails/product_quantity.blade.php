...
<div id="sort_them">
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" align="center" class="full" object="drag-module">
        <tr mc:repeatable>
            <td bgcolor="#bd9e6f" align="center">
                <!-- Mobile Wrapper -->
                                            ...
                                            <table width="100%" border="0" cellpadding="0" cellspacing="0" align="center" style="text-align: center; border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="fullCenter">
                                                <tr>
                                                    <td valign="middle" width="100%" style="text-align: center;" class="fullCenter" object="image-editable">
                                                        <a href="#" target="_blank" style="text-decoration:none;"><img class="em_logo" src="{{media_file(get_setting('logo'))}}" alt="logo" width="51" height="51" border="0" style="text-align:center;"  /></a>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                ...
                                <tr>
                                    <td align="center" width="100%" valign="middle" bgcolor="#ffffff" style="-webkit-border-radius: 5px; -moz-border-radius: 5px; border-radius: 5px;">
                                        ...
                                        <div class="sortable_inner">
                                            <table width="100%" border="0" cellpadding="0" cellspacing="0" align="center" class="full" style="border-top-right-radius: 5px; border-top-left-radius: 5px;">
                                                <tr>
                                                    <td align="center" valign="bottom" bgcolor="#2c2a2b" style="border-top-right-radius: 5px; border-top-left-radius: 5px;">
                                                        <img src="images/img2.png" alt="" class="em_full_img" border="0" style="vertical-align:bottom;"/>
                                                    </td>
                                                </tr>
                                            </table>
                                            ...
                                            <table align="center" width="100%" border="0" cellspacing="0" cellpadding="0" object="drag-module-small">
                                                <tr>
                                                    <td height="45" class="em_h40"><img src="images/spacer.gif" width="1" alt="" height="1" border="0" style="display:block;" /></td>
                                                </tr>
                                            </table>
                                            ...
                                            <table width="290" border="0" cellpadding="0" cellspacing="0" align="center" class="full" object="drag-module-small">
                                                <tr>
                                                    <td align="center" width="250" valign="middle" class="em_pad">
                                                        ...
                                                        <table width="100%" border="0" cellpadding="0" cellspacing="0" align="center" style="text-align: center; border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="fullCenter">
                                                            <tr>
                                                                <td width="100%" align="center" style="font-size:30px; color:#161619; font-family:'Lato',Arial, sans-serif; font-weight:400; line-height:34px;">{{$details['title']}} </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                </tr>
                                            ...
                                            <table align="center" width="570" border="0" cellspacing="0" cellpadding="0"
                                                ...
                                                <tr>
                                                    <td height="15" bgcolor="#fafafa"><img src="images/spacer.gif"
                                                                                           width="1" alt=""
                                                                                           height="1" border="0"
                                                                                           style="display:block;"/>
                                                    </td>
                                                        ...
                                                        <table align="center" width="500" border="0" cellspacing="0"
                                                            ...
                                                            <tr>
                                                                <td valign="middle" align="left" width="63%"
                                                                    ...
                                                                    <a href="{{url('product/'.$details['product']->id.'/edit')}}" style="text-decoration: none">

                                                                        {{$details['product']->short_title}} <br/>
                                                                        <span style="font-size:15px; color:#a3ca66; font-family:'Lato',Arial, sans-serif; font-weight:700;">{{ $details['product']->title}} </span>
                                                                    </a>


                                                                </td>
                                                                <td width="25%" align="left"
                                                                    style="font-size:13px; color:#aaaaaa; font-family:'Lato',Arial, sans-serif; font-weight:400;">{{currency($details['product']->price)}}
                                                                    <br/>

                                                                    <span style="font-size:15px; color:#aaaaaa; font-family:'Lato',Arial, sans-serif; font-weight:700;"> {{currency($details['product']->price)}}</span>
                                                                </td>
                                                                <td><img src="{{media_file($details['product']->image)}}"
                                            ...
                                            <table border="0" cellpadding="0" cellspacing="0" align="center" class="em_wrapper" object="drag-module-small">
                                                <tr>
                                                    <td width="100%" align="center">
                                                        <table border="0" cellpadding="0" cellspacing="0" align="center" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="mcenter" width="250px">
                                                            <tr>
                                                                <td width="100%" align="center"><!-- SORTABLE -->
                                                                    ...
                                                                    <div class="sortable_inner">
                                                                        <table border="0" cellpadding="0" cellspacing="0" class="mcenter"   >
                                                                            <tr>
                                                                                <td align="center" valign="middle" height="40" bgcolor="#161619" style="font-size:14px;  font-family:'Lato',Arial, sans-serif; font-weight:700; color:#ffffff; border-radius:25px; background:#161619;padding-left:20px; padding-right:20px;"  >
                                                                                    <a href="{{route('backend.products.edit', ['product' => $details['product']->id])}}" target="_blank" style="text-decoration:none; color:#ffffff; line-height:31px; display:block;" object="link-editable" >
                                                                                        {{$details['button']}}</a></td>
                                                                            </tr>
                                                                        </table>
                                                                    </div></td>
                                            ...
                                            <table align="center" width="100%" border="0" cellspacing="0"
                                                ...
                                                <tr>
                                                    <td valign="top" align="center"
                                                        style="font-family:'Lato', Arial, sans-serif; font-weight:400; font-size:11px; color:#aaaaaa; line-height:22px;">
                                                        &copy; 2022 <a href="{{get_setting('app_url')}}"
                                                                       style="text-decoration:underline; color:#aaaaaa;"

                                                        >{{get_translatable_setting('system_name','en')}}.</a> All Rights Reserved.
                                                    </td>
                                                </tr>
                                            </table>
