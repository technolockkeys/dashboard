                                ...
                                <table width="100%" border="0" cellpadding="0" cellspacing="0" align="center"
                                    ...
                                    <tr>
                                        <td align="center" width="100%" valign="middle" height="51">
                                            <img src="{{media_file(get_setting('system_logo_icon'))}}" alt="logo"
                                                 height="51"
                                                 style="height:51px;"/>
                                                                            ...
                                                                            <table border="0" cellpadding="0"
                                                                                ...
                                                                                <tr>
                                                                                    <td align="center" valign="middle"
                                                                                        height="40" bgcolor="#f17805"
                                                                                        style="font-size:14px;  font-family:'Lato',Arial, sans-serif; font-weight:400; color:#ffffff; border-radius:5px; background:#f17805; padding-left:15px; padding-right:15px;">
