        ...
        <div class="col">
            <div class="card flex-row-fluid mb-2  ">
                <div class="card-header">
                    <h3 class="card-title"> {{trans('backend.brand.create_new_brand')}}</h3>
                                ...
                                <div class="row mb-6">
                                    <div class="col-12 col-md-12 mb-10">
                                        ...
                                        <input class="form-control" id="make_{{$item->code}}" name="make_{{$item->code}}"
                                               value="{{old('make_'.$item->code)}}"
                                               placeholder="Type a brand name"/>

                                        @error('make') <b class="text-danger"><i
                ...
                <div class="card-body">
                    ...
                    <div class="row flex-center">
                        ...
                        <div class="col-12 col-md-6 mb-10">
                            ...
                            <input class="form-control" type="number" id="pin_code_price" name="pin_code_price"
                                   value="{{old('pin_code_price')}}"
                                   />
