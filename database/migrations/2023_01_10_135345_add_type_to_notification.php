...
return new class extends Migration {
    ...
    {
        DB::statement("alter table notifications modify type enum('out_of_stock', 'low_quantity', 'review_added', 'new_order', 'order_delivered', 'order_canceled', 'order_refunded') not null;");
    }
};
