<div class="card card-xxl-stretch mb-5 mb-xl-8" style="background-color: #F7D9E3">
    <div class="card-body d-flex flex-column">
        <div class="d-flex flex-column mb-7">
            <a href="{{route('backend.orders.index')}}" class="text-dark text-hover-primary fw-bolder fs-3">{{trans('backend.order.order_type')}}</a>
        </div>
        <div class="row g-0">
            <div class="col-6">
                <div class="d-flex align-items-center mb-9 me-2">
                    ...
                    <div>
                        <div class="fs-5 text-dark fw-bolder lh-1">{{$orders['total']}}</div>
                        <div class="fs-7 text-gray-600 fw-bold">{{trans('backend.order.all')}}</div>
                    </div>
                </div>
            </div>
            <div class="col-6">
                <div class="d-flex align-items-center mb-9 ms-2">
                    ...
                    <div>
                        <div class="fs-5 text-dark fw-bolder lh-1">{{$orders['order']}}</div>
                        <div class="fs-7 text-gray-600 fw-bold">{{trans('backend.order.order')}}</div>
                    </div>
                </div>
            </div>
            @if(false)
            <div class="col-6">
                <div class="d-flex align-items-center me-2">
                    ...
                    <div>
                        <div class="fs-5 text-dark fw-bolder lh-1">{{$orders['pin_code']}}</div>
                        <div class="fs-7 text-gray-600 fw-bold">{{trans('backend.order.pin_code')}}</div>
                    </div>
                </div>
            </div>
            @endif
            <div class="col-6">
                <div class="d-flex align-items-center ms-2">
                    ...
                    <div>
                        <div class="fs-5 text-dark fw-bolder lh-1">{{$orders['proforma']}}</div>
                        <div class="fs-7 text-gray-600 fw-bold">{{trans('backend.order.proforma')}}</div>
                    </div>
                </div>
            </div>
        </div>
