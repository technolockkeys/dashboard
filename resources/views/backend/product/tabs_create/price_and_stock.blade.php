<div class="row">
    <div class="col-12 col-md-6">
        <div class="form-group">
            ...
            <input type="number" step="2" class="form-control" name="price" id="price" value="{{old('price')}}">
    ...
    <div class="col-12 col-md-6">
        <div class="form-group">
            ...
            <input type="number" step="2" class="form-control" value="{{old('sale_price')}}" name="sale_price"
                   id="sale_price">
...
<div class="row">
    ...
    <div class="col-12 col-md-6">
        <div class="form-group">
            ...
            <input type="number" step="2" value="{{old('discount_value' , '')}}" class="form-control"
...
<div class="row">
    <div class="col">
        <table class="table text-center table-striped table-bordered table-hover">
            ...
            @if(!empty(old('serial_number', [])))
                @foreach(old('serial_number' ) as  $key=>$from)
                    <tr data-row='uuid_{{$key}}'>
                        <td><input type='text' value="{{old('serial_number')[$key]}}" required class='form-control' name='serial_number[]'></td>
                        <td>
                            <button type='button' data-uuid='uuid_{{$key}}'
                                    class='btn btn-danger btn-icon btn-sm btn-hover-scale     remove-row'><i
