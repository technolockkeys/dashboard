@if(permission_can('show redirects' ,'admin') )
    <div
            class="menu-item  @if(request()->routeIs('backend.redirects.*')  )here show @endif ">
        <a class="menu-link"
           href="{{route('backend.redirects.index')}}">

										<span class="menu-icon">
<!--begin::Svg Icon | path: /var/www/preview.keenthemes.com/kt-products/docs/metronic/html/releases/2022-08-29-071832/core/html/src/media/icons/duotune/arrows/arr031.svg-->
<span class="svg-icon svg-icon-muted "><svg width="23" height="24" viewBox="0 0 23 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<path opacity="0.3" d="M21.7 6.29999C22.1 6.69999 22.1 7.30001 21.7 7.70001L18.4 11V3L21.7 6.29999ZM2.3 16.3C1.9 16.7 1.9 17.3 2.3 17.7L5.6 21V13L2.3 16.3Z" fill="currentColor"/>
            ...
            <span class="menu-title">{{trans('backend.menu.redirects')}}</span>
