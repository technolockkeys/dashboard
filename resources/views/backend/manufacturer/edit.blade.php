...
@section('content')
    <div class="col">
        <form action="{{route('backend.manufacturers.update',[ $manufacturer->id])}}" method="post" enctype="multipart/form-data">
            @csrf
            @method('patch')
            <div class="card flex-row-fluid mb-2  ">
                <div class="card-header">
                    <h3 class="card-title"> {{trans('backend.manufacturer.edit',['name'=> $manufacturer->title])}}</h3>
                    ...
                    <div class="tab-content" id="myTabContent">
                        @foreach(get_languages() as $key=> $item)
                            <div class="tab-pane fade   @if($key == 0 )show active @endif" id="{{$item->code}}"
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            name="title_{{$item->code}}" value="{{old('title_'.$item->code, $manufacturer->getTranslation('title', $item->code))}}">
                                ...
                                <div class="row  ">
                                    <div class="col form-group ">
                                        <div class="form-group">
                                            ...
                                            > {{old('description_'.$item->code, $manufacturer->getTranslation('description', $item->code))}}</textarea>
                                ...
                                {!! form_seo($item->code , $key ,old('meta_title_'.$item->code, $manufacturer->getTranslation('meta_title', $item->code)),old('meta_description_'.$item->code, $manufacturer->getTranslation('meta_description', $item->code))) !!}
                ...
                <div class="card-body">
                    <div class="row mb-10">
                        ...
                        <div class="col form-group ">
                            <div class="form-group  align-items-center">
                                ...
                                <div class="form-check form-switch form-check-custom form-check-solid me-10">
                                    <input class="form-check-input h-20px w-30px" @if(old('software', $manufacturer->software) == 1 ) checked
                        ...
                        <div class="col form-group ">
                            ...
                            <div class="form-group  align-items-center">
                                <div class="form-check form-switch form-check-custom form-check-solid me-10">
                                    <input class="form-check-input h-20px w-30px" @if(old('token', $manufacturer->token) == 1 ) checked
                                           @endif type="checkbox" value="1"
                                           name="token" id="token"/>
                        ...
                        <div class="col form-group ">
                            ...
                            <div class="form-group  align-items-center">
                                <div class="form-check form-switch form-check-custom form-check-solid me-10">
                                    <input class="form-check-input h-20px w-30px" @if(old('status', $manufacturer->status) == 1 ) checked
                                           @endif type="checkbox" value="1"
                    ...
                    <div class="form-group row">
                        <div class="col  align-items-center">
                            <div class="col form-group ">
                                ...
                                <br>
                                {!! single_image('image' , media_file(old('image',$manufacturer->image)) , old('image',$manufacturer->image)  ) !!}
                                <br>
